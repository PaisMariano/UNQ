...
promedio :: [Int] -> Int
--Dada una lista de numeros, retorna el promedio entre ellas.
promedio xs = sumatoria xs `div` longitud xs 

apariciones :: Eq a => a -> [a] -> Int
--Dada um elemento y una lista, retorna la cantidad de veces que se repite dicho elemento en la lista pasada por parametro. 
--apariciones z [] = ...
...
sumatoria :: [Int] -> Int
--Dada una lista de numeros, retorna el resultado que se obtiene de sumarlos todos.
sumatoria [] = 0
sumatoria (n : ns) = n + sumatoria ns


isEmpty :: [a] -> Bool
--Dada una lista, retorna si la misma es vacia.
isEmpty [] = True
isEmpty _ = False