...
--Conjuntos: Tercera implementacion, cn maximo mediante recorrido

module Conjunto3(Set, emptyS, addS, belongS, sizeS, removeS, unionS, setTolist, conjuntoPar, conjuntoImpar, conjuntoFibbonacci, arbolDeConjuntos) where

import Listas
import Auxiliares

data Set a = MkSet [a] Elems deriving(Show) --Tipo de representacion: Listas de a.
type Elems = Int
