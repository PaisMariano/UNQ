module Listas (pertenece, sonLoMismo, sinRepetidos, longitud, filtrarElemento, contarNoRepetidos, elementosEnComun, promedio, apariciones, isEmpty)where
...
promedio :: [Int] -> Int
--Dada una lista de numeros, retorna el promedio entre sus elementos.
promedio xs = sumatoria xs `div` longitud xs 

apariciones :: Eq a => a -> [a] -> Int
--Dada un elemento y una lista del mismo tipo que ese elemento, retorna la cantidad de veces que ese elementoo aparece en dicha lista.
--apariciones z [] = ...
...
sumatoria :: [Int] -> Int
--Dada una lista de numeros, retorna la suma de todos sus elementos.
sumatoria [] = 0
sumatoria (n : ns) = n + sumatoria ns

isEmpty :: [a] -> Bool
--Dada una lista, retorna si la misma es una lista vacia.
isEmpty [] = True
isEmpty _ = False
