...
--pertenece x [] = ...
--pertenece x (x : xs) = ... pertenece x xs
...
--sinRepetidos [] = ...
--sinRepetidos (x : xs) = ... sinRepetidos xs
sinRepetidos [] = []
...
--filtrarElemento x [] = ...
--filtrarElemento x (x : xs) = ... filtrarElemento xs
filtrarElemento x [] = []
...
--contarNoRepetidos [] = ...
--contarNoRepetidos (x : xs) = ... contarNoRepetidoos xs
contarNoRepetidos [] = 0
...
--elementosEnComun [] ys = ...
--elementosEnComun (x : xs) ys = ... elementosEnComun xs ys
elementosEnComun [] _ = []
